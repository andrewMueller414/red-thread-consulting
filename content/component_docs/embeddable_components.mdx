...
If it is not, you don't need the second instance of it's name and you can just write as follows. This is common for things like inputs where nothing really belongs inside of it.
...
This is the most common, and unfortunately the only one that's even remotely challenging. Since the 'x' in mdx is really just 'jsx', you have to know how javascript handles strings. The key points are:

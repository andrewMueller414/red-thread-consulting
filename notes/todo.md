...
- [ ] Setup monaco editor to support shiki for syntax highlighting for it's mdx support.
- [ ] Setup editor with solid theme provided by shiki that aligns with rest of app.
